...
import org.tms.servis.LoginPageService;
...
public class LoginPageTest extends BaseTest {
    ...
    public void  loginTest(){
        ...
        Assert.assertEquals(actualTextOfInventoryPage,expectedPageText,"The actual text of the page does not natch expected!");
    }
}
